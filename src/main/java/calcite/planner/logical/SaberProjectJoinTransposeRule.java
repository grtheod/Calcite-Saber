...
public class SaberProjectJoinTransposeRule extends RelOptRule {
	  public static final SaberProjectJoinTransposeRule INSTANCE =
	      new SaberProjectJoinTransposeRule(
	   ...
	   */
	  public SaberProjectJoinTransposeRule(
	      PushProjector.ExprCondition preserveExprCondition,
	      RelBuilderFactory relFactory) {
	    super(
	        operand(EnumerableProject.class,
	  ...
	  public void onMatch(RelOptRuleCall call) {
	    EnumerableProject origProj = call.rel(0);
