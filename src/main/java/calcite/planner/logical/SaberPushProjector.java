...
/**
 * SaberPushProjector is a utility class used to perform operations used in push
 * projection rules.
 *
 ...
 */
public class SaberPushProjector {
  //~ Instance fields --------------------------------------------------------

  private final EnumerableProject origProj;
  ...
  /**
   * Creates a SaberPushProjector object for pushing projects past a RelNode.
   *
   ...
   */
  public SaberPushProjector(
      EnumerableProject origProj,
      RexNode origFilter,
      RelNode childRel,
    ...
    if (childRel instanceof EnumerableJoin) {
      EnumerableJoin joinRel = (EnumerableJoin) childRel;
   ...
   */
  public EnumerableProject createProjectRefsAndExprs(
      RelNode projChild,
      boolean adjust,
      boolean rightSide) {
    ...
    return (EnumerableProject) RelOptUtil.createProject(
        projChild,
   ...
   *
   * @see org.apache.calcite.rel.rules.SaberPushProjector.OperatorExprCondition
   */
