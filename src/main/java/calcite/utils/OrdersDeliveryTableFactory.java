 ...
 */
	...
	public OrdersDeliveryTableFactory(int inputRate) {
	...
	public Table create(SchemaPlus schema, String name, Map<String, Object> operand, RelDataType rowType) {
		...
		return new OrdersDeliveryTable(ImmutableList.copyOf(rows), useRatesCostModel, inputRate);
	}
	...
	public static class OrdersDeliveryTable implements ScannableTable {
		...
		public OrdersDeliveryTable(ImmutableList<Object[]> rows, boolean useRatesCostModel, int inputRate) {
			this.rows = rows;
			this.useRatesCostModel = useRatesCostModel;
			this.inputRate = inputRate;
		}
